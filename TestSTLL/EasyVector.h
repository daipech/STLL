...
inline bool Easy_vector_Checklenth(__m128 a,float lenth)
{	
	return	(a.m128_f32[0]*a.m128_f32[0]+
			a.m128_f32[1]*a.m128_f32[1]+
			a.m128_f32[2]*a.m128_f32[2])>lenth?true:false;
}
